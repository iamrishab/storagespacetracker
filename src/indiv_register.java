...
/**
 * Servlet implementation class indiv_register
 */
@WebServlet("/indiv_register")
public class indiv_register extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd=request.getRequestDispatcher("indiv_user.jsp");
